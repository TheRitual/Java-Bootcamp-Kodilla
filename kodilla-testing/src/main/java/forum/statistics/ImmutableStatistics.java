...
public final class ImmutableStatistics {
    ...
    public ImmutableStatistics(int amountOfUsers, int amountOfPosts, int amountOfComments, double averagePostsPerUser, double averageCommentsPerUser, double averageCommentsPerPost) {
