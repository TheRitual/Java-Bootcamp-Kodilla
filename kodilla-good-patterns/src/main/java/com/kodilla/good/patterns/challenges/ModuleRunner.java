...
public class ModuleRunner {
    public static void main(String[] args) {
        ...
        Set<SingleOrder> shoppingList = new HashSet<>();
        shoppingList.add(new SingleOrder(ProductType.BIKE,1));
        shoppingList.add(new SingleOrder(ProductType.COMPUTER,2));
        shoppingList.add(new SingleOrder(ProductType.SOCKS,5));
